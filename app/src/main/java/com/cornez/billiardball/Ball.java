...
public class Ball {
    ...
    private double SMALLACCELERATION = 1.003;
    private double LARGEACCELERATION = 1.03;
    ...
    public void moveSmallAcc(){
        mX +=  mVelocityX;
        mY +=  mVelocityY;
        mVelocityX *= SMALLACCELERATION;
        mVelocityY *= SMALLACCELERATION;
        checkCollision();
    }

    public void moveLargeAcc(){
        mX +=  mVelocityX;
        mY +=  mVelocityY;
        mVelocityX *= LARGEACCELERATION;
        mVelocityY *= LARGEACCELERATION;
        checkCollision();
    }
